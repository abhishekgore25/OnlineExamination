...
import javax.swing.*;
import java.util.*;
class detailToVerify extends JPanel{
		ImageIcon bg=new ImageIcon("bbb.png");
		Image bgblue=bg.getImage();
		
		ImageIcon b44=new ImageIcon("imback.png");
		ImageIcon ii=new ImageIcon("imver.png");
		ImageIcon ii2=new ImageIcon("imdis.png");
		ImageIcon b11=new ImageIcon("imsr.png");
		
		
		JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,t1,t10;
		JTextField t2,t3,t4,t5,t6,t7,t8,t9,t11;
		JButton b3,b4;
		JButton b1;
		JButton ver,dis;
